...
const Demo = () => {
    ...
    // Make API Request to Summarize API
    ...
    return (
        <section className="mt-16 w-full max-w-xl">
            <div className="flex flex-col w-full gap-2">
                <form 
                    action=""
                    className="relative flex justify-cetner items-center"
                        ...
                        article.summary && (
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="summary_box">
                                    <p className="font-inter font-medium text-sm/6 text-gray-600 ">{article.summary}</p>
                                </div>
                            </div>
                        )
                    )}
